...
namespace modules\quotesmodule\migrations;
...
class Install extends Migration
{
    ...
    // quotesmodule_quotesmodulerecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%quotesmodule_quotesmodulerecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%quotesmodule_quotesmodulerecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    // quotesmodule_quotesmodulerecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%quotesmodule_quotesmodulerecord}}', 'siteId'),
            '{{%quotesmodule_quotesmodulerecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // quotesmodule_quotesmodulerecord table
        $this->dropTableIfExists('{{%quotesmodule_quotesmodulerecord}}');
    }
}
